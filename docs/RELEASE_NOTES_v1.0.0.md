...
**PEP 440 version:** `1.0.0`  
**Marketing label:** v1.0.0  
**Previous release candidate:** [v1.0.0-rc1](RELEASE_NOTES_v1.0.0-rc1.md) (`1.0.0rc1`, tag `v1.0.0-rc1`)
...
| **v1.0.0** | Stable release; same feature set as rc1 after readiness audit |

## Upgrade notes from v1.0.0-rc1

- Version string is now `1.0.0` (`python -m governor version`).
...
- For governed runs with gate profile `fast`, ensure `pytest` is on `PATH` (e.g. `.venv/bin`) or use `--continue-on-gate-warn` when optional linters are skipped.
