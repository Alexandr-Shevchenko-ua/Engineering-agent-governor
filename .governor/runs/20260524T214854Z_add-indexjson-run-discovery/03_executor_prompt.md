...
**Task:** Add index.json run discovery  
...
- Keep scope minimal and aligned with: Add index.json run discovery
...
`python -m governor record --run-id 20260524T214854Z_add-indexjson-run-discovery --role executor --file <your_output.md>`
