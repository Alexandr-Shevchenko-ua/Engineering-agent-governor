...
- Keep scope minimal and aligned with: Runner profile validation echo dogfood
...
`python -m governor record --run-id 20260525T105525Z_runner-profile-validation-echo-dogfood --role executor --file <your_output.md>`
