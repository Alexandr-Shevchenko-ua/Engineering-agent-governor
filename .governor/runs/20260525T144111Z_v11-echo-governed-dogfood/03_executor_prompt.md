...
- Keep scope minimal and aligned with: v1.1 echo governed dogfood
...
`python -m governor record --run-id 20260525T144111Z_v11-echo-governed-dogfood --role executor --file <your_output.md>`
