...
- Keep scope minimal and aligned with: Dogfood v0.2.2 clean workflow
...
`python -m governor record --run-id 20260525T075337Z_dogfood-v022-clean-workflow --role executor --file <your_output.md>`
